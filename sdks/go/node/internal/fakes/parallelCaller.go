...
type FakeParallelCaller struct {
	CallStub        func(context.Context, chan model.Event, string, map[string]*model.Value, string, string, []*model.CallSpec, string) (map[string]*model.Value, error)
...
func (fake *FakeParallelCaller) Call(arg1 context.Context, arg2 chan model.Event, arg3 string, arg4 map[string]*model.Value, arg5 string, arg6 string, arg7 []*model.CallSpec, arg8 string) (map[string]*model.Value, error) {
	...
	fake.recordInvocation("Call", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6, arg7Copy, arg8})
...
func (fake *FakeParallelCaller) CallCalls(stub func(context.Context, chan model.Event, string, map[string]*model.Value, string, string, []*model.CallSpec, string) (map[string]*model.Value, error)) {
	fake.callMutex.Lock()
	defer fake.callMutex.Unlock()
	fake.CallStub = stub
}

func (fake *FakeParallelCaller) CallArgsForCall(i int) (context.Context, chan model.Event, string, map[string]*model.Value, string, string, []*model.CallSpec, string) {
	fake.callMutex.RLock()
	defer fake.callMutex.RUnlock()
